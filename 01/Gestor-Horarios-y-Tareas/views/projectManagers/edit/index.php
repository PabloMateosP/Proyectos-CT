            ...
            <div class="card-body">
                ...
                <form action="<?= URL ?>projectManagers/update/<?= $this->id ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" step="any" class="form-control" id="name" name="name" value="<?= $this->projectManager->name ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="last_name" name="last_name" value="<?= $this->projectManager->last_name ?>">
                        <!-- Show possible error -->
