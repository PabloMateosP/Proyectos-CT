...
class workingHoursModel extends Model
{
    ...
    public function get()
    {
        try {
            ...
            WHERE YEARWEEK(wh.date_worked, 1) = YEARWEEK(CURDATE(), 1) 
            ORDER by wh.id asc ;";
    ...
    # ---------------------------------------------------------------------------------
    #
    #     _____ ______ _______   ________   _______   ____  _____ _______ 
    #    / ____|  ____|__   __| |  ____\ \ / /  __ \ / __ \|  __ \__   __|
    #   | |  __| |__     | |    | |__   \ V /| |__) | |  | | |__) | | |   
    #   | | |_ |  __|    | |    |  __|   > < |  ___/| |  | |  _  /  | |   
    #   | |__| | |____   | |    | |____ / . \| |    | |__| | | \ \  | |   
    #    \_____|______|  |_|    |______/_/ \_\_|     \____/|_|  \_\ |_|  
    # 
    # ---------------------------------------------------------------------------------  
    # Method get export
    # Method to tale the data of workingHours to export
    ...
    public function get_employeeHours($user_email)
    {
        try {
            $sql = "SELECT 
                    ...
                    WHERE
                        u.email = :email AND YEARWEEK(wh.date_worked, 1) = YEARWEEK(CURDATE(), 1)
                    ORDER BY wh.id ASC;";
    ...
    #   | |  __| |__     | |    | |__  | \  / | |__) | |   | |  | \ \_/ /| |__  | |__    | |__| | |  | | |  | | |__) | (___   | |__   \ V /| |__) | |  | | |__) | | |   
    #   | | |_ |  __|    | |    |  __| | |\/| |  ___/| |   | |  | |\   / |  __| |  __|   |  __  | |  | | |  | |  _  / \___ \  |  __|   > < |  ___/| |  | |  _  /  | |   
    #   | |__| | |____   | |    | |____| |  | | |    | |___| |__| | | |  | |____| |____  | |  | | |__| | |__| | | \ \ ____) | | |____ / . \| |    | |__| | | \ \  | |   
    #    \_____|______|  |_|    |______|_|  |_|_|    |______\____/  |_|  |______|______| |_|  |_|\____/ \____/|_|  \_\_____/  |______/_/ \_\_|     \____/|_|  \_\ |_|   
    #
    # ---------------------------------------------------------------------------------
    # Method get employee Hours Export 
    # Method to take the workings hours of an employee to export
    ...
    # ---------------------------------------------------------------------------------
    #
    #     _____ ______ _______   ______ __  __ _____  _      ______     ________ ______   _    _  ____  _    _ _____   _____   ________   _______   ____  _____ _______   ___  
    #    / ____|  ____|__   __| |  ____|  \/  |  __ \| |    / __ \ \   / /  ____|  ____| | |  | |/ __ \| |  | |  __ \ / ____| |  ____\ \ / /  __ \ / __ \|  __ \__   __| |__ \ 
    #   | |  __| |__     | |    | |__  | \  / | |__) | |   | |  | \ \_/ /| |__  | |__    | |__| | |  | | |  | | |__) | (___   | |__   \ V /| |__) | |  | | |__) | | |       ) |
    #   | | |_ |  __|    | |    |  __| | |\/| |  ___/| |   | |  | |\   / |  __| |  __|   |  __  | |  | | |  | |  _  / \___ \  |  __|   > < |  ___/| |  | |  _  /  | |      / / 
    #   | |__| | |____   | |    | |____| |  | | |    | |___| |__| | | |  | |____| |____  | |  | | |__| | |__| | | \ \ ____) | | |____ / . \| |    | |__| | | \ \  | |     / /_ 
    #    \_____|______|  |_|    |______|_|  |_|_|    |______\____/  |_|  |______|______| |_|  |_|\____/ \____/|_|  \_\_____/  |______/_/ \_\_|     \____/|_|  \_\ |_|    |____|
    #
    # ---------------------------------------------------------------------------------
    # Method get employee hours export 2
    # This method allow to export the working hours of an employee by a date filter
    ...
    # ---------------------------------------------------------------------------------
    #
    #     _____ ______ _______   ________   _______   ____  _____ _______   ___  
    #    / ____|  ____|__   __| |  ____\ \ / /  __ \ / __ \|  __ \__   __| |__ \ 
    #   | |  __| |__     | |    | |__   \ V /| |__) | |  | | |__) | | |       ) |
    #   | | |_ |  __|    | |    |  __|   > < |  ___/| |  | |  _  /  | |      / / 
    #   | |__| | |____   | |    | |____ / . \| |    | |__| | | \ \  | |     / /_ 
    #    \_____|______|  |_|    |______/_/ \_\_|     \____/|_|  \_\ |_|    |____|
    #
    # ---------------------------------------------------------------------------------
    # Method get export 2
    # Method to export the working hours by a date filter
    ...
    #
    # ---------------------------------------------------------------------------------
    # Method get total hours
    # Method to get the total hours from an employee
    ...
    # Like the method read it allow to take the data of an employee (the name and id)
    ...
    # ---------------------------------------------------------------------------------
    #
    #     _____ ______ _______   ______ __  __ _____  _      ______     ________ ______   ______ __  __          _____ _      
    #    / ____|  ____|__   __| |  ____|  \/  |  __ \| |    / __ \ \   / /  ____|  ____| |  ____|  \/  |   /\   |_   _| |     
    #   | |  __| |__     | |    | |__  | \  / | |__) | |   | |  | \ \_/ /| |__  | |__    | |__  | \  / |  /  \    | | | |     
    #   | | |_ |  __|    | |    |  __| | |\/| |  ___/| |   | |  | |\   / |  __| |  __|   |  __| | |\/| | / /\ \   | | | |     
    #   | |__| | |____   | |    | |____| |  | | |    | |___| |__| | | |  | |____| |____  | |____| |  | |/ ____ \ _| |_| |____ 
    #    \_____|______|  |_|    |______|_|  |_|_|    |______\____/  |_|  |______|______| |______|_|  |_/_/    \_\_____|______|
    #
    # ---------------------------------------------------------------------------------
    # Method get employee email
    # Method to take the email of an employee by his id 
    ...
    # ---------------------------------------------------------------------------------   
    # 
    #    _____ _    _ ____ _______ _____            _____ _______   _______ _    _ 
    #   / ____| |  | |  _ \__   __|  __ \     /\   / ____|__   __| |__   __| |  | |
    #  | (___ | |  | | |_) | | |  | |__) |   /  \ | |       | |       | |  | |__| |
    #   \___ \| |  | |  _ <  | |  |  _  /   / /\ \| |       | |       | |  |  __  |
    #   ____) | |__| | |_) | | |  | | \ \  / ____ \ |____   | |       | |  | |  | |
    #  |_____/ \____/|____/  |_|  |_|  \_\/_/    \_\_____|  |_|       |_|  |_|  |_|
    # 
    # ---------------------------------------------------------------------------------
    # Method subtractTH
    ...
    public function orderEmp(int $criterio, $id)
    {
        try {
            $sql = "SELECT 
                    ...
                    LEFT JOIN 
                        tasks t ON wh.id_task = t.id
                    WHERE wh.id_employee = :id AND YEARWEEK(wh.date_worked, 1) = YEARWEEK(CURDATE(), 1)
                    ORDER by :criterio;";
    ...
    public function filter($expresion)
    {
        try {
            ...
            $sql = "SELECT 
                        ...
                        p.project AS project_name,  
                        t.description AS task_description,  
                        wh.description AS work_order_description, 
                        wh.date_worked, 
                        wh.duration 
                    FROM 
                        working_hours wh
                    ...
                    LEFT JOIN 
                        tasks t ON wh.id_task = t.id
                    WHERE YEARWEEK(wh.date_worked, 1) = YEARWEEK(CURDATE(), 1) and
                        concat_ws(  
                            ' ',
                            emp.last_name,
                            emp.name,
