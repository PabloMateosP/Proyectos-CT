            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['new']) ?: 'disabled' ?>"
                        href="<?= URL ?>clientes/nuevo">Nuevo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['export']) ?: 'disabled' ?>" href="<?= URL ?>clientes/exportar">Exportar CSV</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['export']) ?: 'disabled' ?>"
                        href="<?= URL ?>clientes/pdf">Exportar PDF</a>
                </li>
